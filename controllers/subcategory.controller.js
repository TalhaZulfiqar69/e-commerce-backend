...
class SubCategoryController {
     ...
     * @description Method to getAllSubCategories
     * @date 15 March 2023
     ...
     * @param req request body
     * @param res callback response object
     * @description Method to createSubCategory
     * @date 15 March 2023
     * @updated 15 March 2023
     */
     ...
     * @param req request body
     * @param res callback response object
     * @description Method to findSubCategory
     * @date 15 March 2023
     * @updated 15 March 2023
     */
    static findSubCategory = async (req, res) => {
        let response = ResponseHelper.getResponse(
            false,
            'Something went wrong',
            {},
     ...
     * @param req request body
     * @param res callback response object
     * @description Method to updateSubCategory
     * @date 15 March 2023
     * @updated 15 March 2023
     */
     ...
     * @param req request body
     * @param res callback response object
     * @description Method to deleteSubCategory
     * @date 15 March 2023
     * @updated 15 March 2023
     */
