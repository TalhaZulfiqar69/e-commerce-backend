...
class CategoryController {
     ...
     * @description Method to getAllCategories
     * @date 15 March 2023
     ...
     * @param req request body
     * @param res callback response object
     * @description Method to createCategory
     * @date 15 March 2023
     * @updated 15 March 2023
     */
     ...
     * @param req request body
     * @param res callback response object
     * @description Method to findCategory
     * @date 15 March 2023
     * @updated 15 March 2023
     */
     ...
     * @param req request body
     * @param res callback response object
     * @description Method to updateCategory
     * @date 15 March 2023
     * @updated 15 March 2023
     */
     ...
     * @param req request body
     * @param res callback response object
     * @description Method to deleteCategory
     * @date 15 March 2023
     * @updated 15 March 2023
     */
